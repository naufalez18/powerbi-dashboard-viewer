...
```bash
git remote add encore encore://powerbi-dashboard-viewer-6wvi
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/powerbi-dashboard-viewer-6wvi/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/powerbi-dashboard-viewer-6wvi/settings/integrations/github)
